...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('SinglePi0Pt15_cfi.py nevts:$nEventsPerJob'),
...
process.generator = cms.EDProducer("FlatRandomPtGunProducer",
    ...
    psethack = cms.string('single pi 0 pt 15'),
